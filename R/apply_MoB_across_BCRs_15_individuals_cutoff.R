...
perform_analysis_function <- function(bcr_name, grid_size, sample_limit){
  ...
  bootstrap_mobr <- function(draw_number, sample_limit){
    ...
    stats <- get_mob_stats(bird_mob, group_var = 'grid_id', n_perm = 1, effort_samples=15)
  ...
  saveRDS(boot_results, paste0("Intermediate_results/bootstrapping_15_individuals_cutoff/grid_size_", 
